    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Sofia", "Bulgaria", "1000", "Vitosha Blvd 1" });

            migrationBuilder.InsertData(
                table: "Owners",
                columns: new[] { "Id", "AddressId", "Email", "FullName", "PhoneNumber" },
                values: new object[] { 1, 1, "ivan.petrov@example.com", "Ivan Petrov", "+359 88 123 4567" });

            migrationBuilder.InsertData(
                table: "Animals",
                columns: new[] { "Id", "Age", "Breed", "MedicalNotes", "Name", "OwnerId", "Species" },
                values: new object[] { 1, 3, "German Shepherd", "Healthy. Annual vaccinations up to date.", "Rex", 1, "Dog" });
